    ...
    setState(() {
      ...
      if(sector==1000){
        ...
        this.industries=<IntegerValue>[
          const IntegerValue('Agriculture[Select]',0),
        ...
        this.v=new DropDownIntegerValue(industrySetter, industries,50);
x=1;
      }
      if(sector==1200){
        ...
        this.v=null;
        this.industries=<IntegerValue>[
          const IntegerValue('Manufacturing[SELECT]',0),
      ...
      if(sector==1300){
        ...
        this.industries=<IntegerValue>[
          const IntegerValue('Individual[SELECT]',0),
...
print('industry'+industry.toString());
this._customer.target=target;
print('Teager'+target.toString());
